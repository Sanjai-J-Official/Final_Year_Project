            ...
            <main class="max-w-md mx-auto">
                <form id="loginForm" class="bg-white rounded-lg shadow-lg p-8 space-y-6" onsubmit="return validateAndRedirect(event)">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a  href="<?php echo get_template_directory_uri(); ?>/#" class="text-sm text-blue-600 hover:text-blue-800">Forgot password?</a>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <p class="text-gray-600">Don't have an account? 
                            <a  href="<?php echo get_template_directory_uri(); ?>/register.html" class="text-blue-600 hover:text-blue-800">Register here</a>
                        </p>
                    </div>
                </form>
            </main>
    ...
    <script>
        async function validateAndRedirect(event) {
            ...
            try {
               ...
               const response = await fetch('<?php echo get_template_directory_uri(); ?>/data/student-database.json');
